	...
	public static void main(String[] args) {
		...
		Thread user1 = new Thread(new Runnable() {
			...
			public void run() {
				...
				System.out.println(Thread.currentThread().getName() + " attending 4 person : " + jugBoston.getCount());
			}			
		});
		...
		Thread user2 = new Thread(new Runnable() {
			...
			public void run() {
				...
				System.out.println(Thread.currentThread().getName() + " attending 3 person : " + jugBoston.getCount());
				jugBoston.notAttending(3);
				System.out.println(Thread.currentThread().getName() + " not attending 3 person : " + jugBoston.getCount());
			}			
		});
		Thread user3 = new Thread(new Runnable() {
			...
			public void run() {
				...
				System.out.println(Thread.currentThread().getName() + " attending 1 person  : " + jugBoston.getCount());
			}			
		});
